...
This note summarises the original 12-page English report without republishing the complete document or private implementation assets.
...
- deployment of a multi-organisation Fabric environment with Docker;
...
- evaluation scripts or figures for transaction throughput, authentication latency, and CPU utilisation;
